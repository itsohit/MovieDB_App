...
public class TvOnTheAirFragment extends Fragment {
      RecyclerView recyclerView;
      RecyclerView.LayoutManager layoutManager;
        String url = "https://api.themoviedb.org/3/tv/on_the_air?api_key=c686d702de9f7a64b3b2fe2a04f8e7b6&language=en-US&page=1";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = inflater.inflate(R.layout.fragment_tv_on_the_air, container, false);

        recyclerView = (RecyclerView) v.findViewById(R.id.recycelerview_tvOnTheToday);
        ...
        StringRequest stringRequest = new StringRequest(url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        TvAdapter adapter = new TvAdapter(getContext(),(gson.fromJson(response,TvOnTheTodayData.class)).getResults(),adapterOnItemClick);
